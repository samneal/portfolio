...
public class redB : MonoBehaviour {
	...
	void Start () {
		iTween.MoveTo(gameObject,iTween.Hash("path",iTweenPath.GetPath("redBPath"),"time", spawnRed.Instance.redSpeed, "looptype", iTween.LoopType.none, "easetype", iTween.EaseType.linear,"movetopath", false));
